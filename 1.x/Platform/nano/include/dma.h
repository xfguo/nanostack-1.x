...
extern xDMAHandle dma_config(uint8_t channel, void *src, dma_inc_t src_inc, void *dst, dma_inc_t dst_inc, 
			     ...
			     dma_trigger_t trigger, dma_func function);
extern portCHAR dma_arm(xDMAHandle channel);
extern portCHAR dma_abort(xDMAHandle channel);
extern portCHAR dma_trigger(xDMAHandle channel);
extern portCHAR dma_state(xDMAHandle channel);
#endif

extern void dma_ISR( void ) interrupt (DMA_VECTOR);
